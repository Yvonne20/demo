...
class CountRoutes:
    def __init__(self, orig=None, single=None, prior=None, panama_struc=None):
        ...
        print(f"CountRoutes orig   = {self.orig}")
        print(f"CountRoutes single = {self.single}")
        print(f"CountRoutes prior  = {self.prior2}")
        print(f"CountRoutes panama_struc = {self.panama_struc}")
